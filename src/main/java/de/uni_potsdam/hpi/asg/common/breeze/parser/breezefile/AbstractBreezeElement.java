...
public class AbstractBreezeElement extends LinkedList<Object> {
     ...
     * @param level
     *            - a level of indent in the number of spaces
     * @param openedList
     *            - if true for a list, opening and closing brackets will not be
     *            printed
     * @param doNewline
     *            - states, whether to output a "new line" for a list structure
