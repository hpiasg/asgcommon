...
public class GFile {
    ...
    public static boolean writeGFile(STG stg, File file) {
        ...
        text.append(".model anStg" + newline); // otherwise petrify adds the filename as model name and if this file gets read by workcraft it might fail        
